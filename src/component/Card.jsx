...
const Card = ({ item }) => {
    ...
    return (
        <div
            className="w-full max-w-sm bg-[#16181f] border border-[#232733]/80 rounded-2xl overflow-hidden shadow-xl transition-all duration-300 hover:border-zinc-700/80 hover:-translate-y-1 hover:shadow-2xl group">
            {/* Top Workout Image */}
